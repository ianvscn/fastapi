...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'chico'
    assert response.json()['email'] == 'chico@email.com'
    assert response.json()['first_name'] == 'João'
    assert response.json()['last_name'] == 'Francisco'
